...
// @claude   PTZ: patrolLock            분석: loadFail · anaStart.* · analysisStartFail({detail})
// @claude   프로필: profileSaved · profileSaveFail
// @claude   카메라: camSaved · camOn · camOff
const toast = ref(null) // null | kind
const toastParams = ref({}) // t('toast.{kind}', params)의 치환 인자
let hideTimer = null
...
export function useToast() {
  function showToast(kind, params = {}) {
    toast.value = kind
  ...
  return { toast, toastParams, toastIsSuccess, showToast, hideToast }
}
